...

{
    ...
    public class PayFacUtils
    {
        ...
        private const string CONTENT_TYPE = "application/com.vantivcnp.payfac-v17+xml";
        private const string ACCEPT = "application/com.vantivcnp.payfac-v17+xml";
        ...
        private static PayFacWebException GetPayFacWebException(WebException we, Configuration config)
        {
            ...
            if (!webErrorResponse.ContentType.Contains("application/com.vantivcnp.payfac-v17+xml"))
